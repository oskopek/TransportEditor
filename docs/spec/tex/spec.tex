...
\item Save the problem (along with the graph drawing hints). For details, see section \ref{input-output}.
\end{itemize}
...
\begin{wrapfigure}{r}{0.5\textwidth}
        ...
        \caption{seq-sat-6-p30 prototype graph drawing (drawn using \href{https://networkx.github.io/}{networkx})}
        \label{fig:graph}
\end{wrapfigure}
...
%\begin{center}
%\includegraphics[width=0.9\textwidth]{../data/img/pdf/seq-sat-6-p30}\label{fig:graph}
%seq-sat-6-p30 prototype graph drawing
%\end{center}
...
\begin{figure}[h]
        \centering
        \includegraphics[width=0.97\textwidth]{../data/img/pdf/gui}
        \caption{Abstract GUI prototype \TODO add toolbox}
        \label{fig:gui}
\end{figure}
...
\href{https://helios.hud.ac.uk/scommv/IPC-14/repository/kovacs-pddl-3.1-2011.pdf}{definiton of PDDL 3.1}.
