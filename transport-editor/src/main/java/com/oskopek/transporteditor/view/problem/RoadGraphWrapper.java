package com.oskopek.transporteditor.view.problem;
 ...
 */
public final class RoadGraphWrapper extends RoadGraph {
    ...
    public RoadGraphWrapper(RoadGraph graph) {
        super(graph);
    }

    public RoadGraphWrapper(String id) {
        super(id);
        setDefaultStyling();
    }
