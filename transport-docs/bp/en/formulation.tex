...
and a finite number of literals for the values for any given problem instance of
...
domain-independent planners used in the three aforementioned competitions.
