...
{A general search algorithm.}{A general search algorithm
\citep[Section~3.4]{Russell1995}.}{gs}

\subsubsection{BFS}

\myalg{Breadth-First Search}%
{%
\If {$i\geq maxval$}
    \State $i\gets 0$
\Else
...
{The Breadth-First Search algorithm.}{The Breadth-First Search algorithm \citep[Section~3.5]{Russell1995}.}{bfs}
...
\myalg{A*}%
{%
\Require problem, a problem
\Ensure a solution sequence

\Return \Call{General-Search}{problem, Queue-Fn}
}%
{The A* algorithm.}{The A* algorithm \citep[Section~4.1]{Russell1995}.}{astar}
...
\TODO{Define + Advantages and shortcommings of SFA*}
...
\subsection{Heuristics for forward search}

\TODO{heuristics in general}

\TODO{heuristics in Transport}
\TODO{revise}
