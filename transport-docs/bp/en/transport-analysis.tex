...
without sacrificing admissibility \TODO{def}.
\end{enumerate}
...
Information about the model in \texttt{transport-core} and a guide to \texttt{transport-editor} is available in the \nameref{transporteditor-user-manual} and the \nameref{transporteditor-developer-manual}.

The \texttt{transport-benchmark} module

\TODO{benchmark input output format -- planovace} 

\TODO{how to run the benchmark}

\TODO{how do reports work and where they are generated}
