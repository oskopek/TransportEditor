...
\end{thm}
\begin{proof}
As proven by \citet{Karp1972}, the problem of finding a Hamiltonian circuit (HC) in a graph is NP-Complete. We will show that we are able to transform the HC problem into a Sequential Transport problem. \TODO{Verify}.
