...
\end{code}
\caption{PDDL formulation of \texttt{transport-strips}. \TODO{Move to attachments and dedicate page}}
\label{code:pddl-strips}
\end{figure}


Discretised Durative Actions from \citep[Section~5]{Fox2003}.
\TODO{Temporal formulation.} \TODO{add the temporal domain PDDL and move to attachments too}
