...
\centering
\includegraphics[width=1.0\textwidth]{../imga/seq-sat-6-score}
...
\begin{subfigure}{\textwidth}
\centering
\includegraphics[width=1.0\textwidth]{../imga/seq-sat-6-runtime}
...
\begin{subfigure}{\textwidth}
\centering
\includegraphics[width=1.0\textwidth]{../imga/seq-sat-8-score}
