...
\begin{description}
\item[SFA3] The SFA planner (Section~\ref{sfa}) with a package and vehicle distance heuristic (Section~\ref{sfa3})
\item[MSFA3] The meta-heuristically weighted SFA3 planner (Section~\ref{msfa})
\item[RRAPN] The Randomized Restart Around Path Nearby planner (Section~\ref{rrapn})
\item[CSP] The CSP-based planner (Section~\ref{csp-planner})
\end{description}
...
\TODO{comment on MSFA3 and SFA3 once we have the results}
...
and RRAPNTemp achieve total qualities of $23.92/30$
