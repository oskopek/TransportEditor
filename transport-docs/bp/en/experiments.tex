...
admissible heuristic of MSFA5 is that we weight the heuristic,
therefore making it inadmissible.
Based on total quality, MSFA5 comes out on top as the better one of the two MSFA planners on this dataset.


All of our three planners beat all planners from the original competition based on total quality,
