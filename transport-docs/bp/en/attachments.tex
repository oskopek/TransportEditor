...
\item \verb+TransportEditor-\TEver{}/+, the \TEver{} release (Git Tag \TEtag{}) of the TransportEditor software, also obtainable at:\\
...
\end{itemize}
\end{itemize}
The VAL validator (needed for experiments) can be obtained at \url{https://github.com/KCL-Planning/VAL}.
