...
\TODO{Check and fix: typesetting errors, relevance, up2dateness of both manuals}
...
\TODO{Add TE screenshots from the presentation to the manual illustrating the workflow}
