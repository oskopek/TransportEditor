...
def to_json(domain, finished, score):
    ...
    for problem in problems:
        for planner in planners:
            if planner in ["miplan", "nucelar", "planets", "dpmplan", "freelunch", "arvandherd", "bfs-f", "bifd", "fdss-2014", "cedalion", "rpt", "use", "yahsp3", "ibacop2", "uniform", "dae_yahsp"]: # skip low performing planners
                continue
