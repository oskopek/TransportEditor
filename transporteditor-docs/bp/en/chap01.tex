...
Both the planning domain and problem are represented with the notion
...
The state-variable representation substitutes the use of relations of the two previous
representations for functions, using the concept of state variables. State-variable functions are \TODO{def}.



We will later extend these representations using types.
To see that they fit into our previously defined representations, we can
...
\TODO{mention neoclassical planning}

\subsection{Temporal planning}

\TODO{temporal planning}
...
Scheduling adresses the problem of how to perform a given set of actions (a plan)
...
while delivering all packages to their destination. \TODO{mention other potential goals}
