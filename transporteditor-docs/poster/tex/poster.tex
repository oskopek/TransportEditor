...
\usepackage[orientation=portrait,size=a0,scale=1.4]{beamerposter} % Use the beamerposter package for laying out the poster with a portrait orientation and an a0 paper size and scale 1.4
...
\institute{Faculty of Mathematics and Physics, Charles University} % Institution(s)
...
\centering
\begin{figure}
\includegraphics[width=0.8\linewidth]{logo-en}
