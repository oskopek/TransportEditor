...
public class RefuelBuilder extends DefaultActionBuilder<Refuel, FuelVehicle, PlaceholderActionObject> {
    ...
    @Override
    public <Who_ extends FuelVehicle, What_ extends PlaceholderActionObject> Refuel build(Who_ who, Location where,
            What_ what) {
        return build(who, where);
    }

    public <Who_ extends FuelVehicle> Refuel build(Who_ who, Location where) {
