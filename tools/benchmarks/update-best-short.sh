...
TE="TransportEditor"
merged="$prefix/$TEvariant/tools/benchmarks/results-long/merged"
...
python3 scripts/update-best-scores.py "$merged/$track/results-ipc.json" "$prefix/$TEvariant/tools/benchmarks/$results/merged/$track/results.json"
...
./generate-reports.sh "$prefix/$TEvariant/tools/benchmarks/configs/$last_config" "$prefix/$TEvariant/tools/benchmarks/$results/merged/$track/results.json"
done
