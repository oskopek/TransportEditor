...
configs='echo seq-sat-${ipc}-rrapn seq-sat-${ipc}-rrapd seq-sat-${ipc}-msfa3 seq-sat-${ipc}-msfa5 tempo-sat-${ipc}-tfd2014 tempo-sat-${ipc}-rrapnsched tempo-sat-${ipc}-msfa3sched tempo-sat-${ipc}-msfa5sched'
